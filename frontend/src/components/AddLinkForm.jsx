...
import { TbBrowserPlus, TbSettings } from "react-icons/tb";
...
const AddLinkForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-4 rounded shadow-md">
      ...
      <button
        type="submit"
        className="bg-darkBlue text-white p-2 rounded hover:bg-blue-600 flex items-center gap-3"
      >
        Bookmark
      ...
      <a 
        ...
        className="bg-orangish text-white p-2 text-2xl h-full rounded flex items-center justify-center hover:bg-orange-700">
        <TbSettings />
      </a>
      </div>
